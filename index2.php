...
if(!isset($_COOKIE["moncookie"]))
{
  ...
  include_once("Vues\header.2.php"); // ajout à l'aide du php de l'header 

  include_once("Vues\landing.1.php") // ajout à l'aide du php de la landing page (liste des formations)
