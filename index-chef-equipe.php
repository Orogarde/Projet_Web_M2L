...
if(!isset($_COOKIE["moncookie"]))
{
  ...
  include_once("Vues\header-chef.php"); // ajout à l'aide du php de l'header 
  include_once("Vues\session.php"); // ajout à l'aide du php de l'header
  include_once("Vues\landing-validation.php") ;

  include_once("Vues\landing-chef.php"); // ajoutà l'aide du php de la landing page (liste des formations)
